 ...
 * [Filestash](http://www.filestash.app) ([code](https://github.com/mickael-kerjean/filestash)) - An Alternative to Dropbox that let you use your own backend (FTP, SFTP, GIT, Webdav, Minio, ...). It can be use from TOR in 1 click.
